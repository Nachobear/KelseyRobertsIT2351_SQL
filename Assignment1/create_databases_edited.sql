...
-- ********************************************
-- CREATE THE KelseyRobertsOrderManagement DATABASE
-- *******************************************

-- create database
DROP DATABASE IF EXISTS KelseyRobertsOrderManagement;
CREATE DATABASE KelseyRobertsOrderManagement;

-- select database
USE KelseyRobertsOrderManagement;
